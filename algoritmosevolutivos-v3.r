...
ae_v3 <- function(tamanho_populacao, tamanho_cromossomo, numero_de_geracoes) {
  ...
  for(i in 1:nrow(populacao)) { # Interar na quantidade de individuos. Poderia ser tamanho_populacao
    ...
    # Soma cada linha da matriz
    soma = sum(populacao[i,]) # Estamos pegando toda a linha i
    
    # Armazena o fitness de cada individuo em forma de vetor
